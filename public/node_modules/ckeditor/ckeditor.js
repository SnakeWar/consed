...
getClasses:function(){var a=new RegExp("^("+[].concat(g,e).join("|")+")$");return function(){var c=this.repository.parseElementClasses(q(this).getAttribute("class")),b;for(b in c)a.test(b)&&delete c[b];return c}}(),upcast:J(a),downcast:K(a),getLabel:function(){return this.editor.lang.widget.label.replace(/%1/,(this.data.alt||"")+" "+this.pathName)}}}function J(a){var b=r(a),h=a.config.image2_captionedClass;return function(a,g){var d={width:1,height:1},c=a.name,f;if(!a.attributes["data-cke-realelement"]&&
...
a.getAttribute("src");a={width:b.width,height:b.height}}return a},getLinkAttributesGetter:function(){return CKEDITOR.plugins.link.getLinkAttributes},getLinkAttributesParser:function(){return CKEDITOR.plugins.link.parseLinkAttributes}}})();CKEDITOR.config.image2_captionedClass="image";(function(){CKEDITOR.plugins.add("youtube",{lang:"en bg pt pt-br ja hu it fr tr ru de ar nl pl vi zh el he es nb nn fi et sk cs ko eu uk".split(" "),init:function(a){a.addCommand("youtube",new CKEDITOR.dialogCommand("youtube",{allowedContent:"div{*}(*); iframe{*}[!width,!height,!src,!frameborder,!allowfullscreen,!allow]; object param[*]; a[*]; img[*]"}));a.ui.addButton("Youtube",{label:a.lang.youtube.button,toolbar:"insert",command:"youtube",icon:this.path+"images/icon.png"});CKEDITOR.dialog.add("youtube",
...
a.config.youtube_autoplay:!1,label:a.lang.youtube.chkAutoplay}]},{type:"hbox",widths:["55%","45%"],children:[{id:"txtStartAt",type:"text",label:a.lang.youtube.txtStartAt,validate:function(){if(this.getValue()){var l=this.getValue();if(!/^(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)$/i.test(l))return alert(a.lang.youtube.invalidTime),!1}}},{id:"chkControls",type:"checkbox","default":null!=a.config.youtube_controls?a.config.youtube_controls:!0,label:a.lang.youtube.chkControls}]}]}],onOk:function(){var a=
"",c="";if(this.getContentElement("youtubePlugin","txtEmbed").isEnabled())a=this.getValueOf("youtubePlugin","txtEmbed");else{var d="https://",b=[],f,k="",g=this.getValueOf("youtubePlugin","txtWidth"),h=this.getValueOf("youtubePlugin","txtHeight"),d=!0===this.getContentElement("youtubePlugin","chkPrivacy").getValue()?d+"www.youtube-nocookie.com/":d+"www.youtube.com/",d=d+("embed/"+e);!1===this.getContentElement("youtubePlugin","chkRelated").getValue()&&b.push("rel\x3d0");!0===this.getContentElement("youtubePlugin",
"chkAutoplay").getValue()&&(b.push("autoplay\x3d1"),k="autoplay");!1===this.getContentElement("youtubePlugin","chkControls").getValue()&&b.push("controls\x3d0");if(f=this.getValueOf("youtubePlugin","txtStartAt"))f=hmsToSeconds(f),b.push("start\x3d"+f);0<b.length&&(d=d+"?"+b.join("\x26"));!0===this.getContentElement("youtubePlugin","chkResponsive").getValue()&&(a+='\x3cdiv class\x3d"youtube-embed-wrapper" style\x3d"position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"\x3e',
c='style\x3d"position:absolute;top:0;left:0;width:100%;height:100%"');!0===this.getContentElement("youtubePlugin","chkOlderCode").getValue()?(d=d.replace("embed/","v/"),d=d.replace(/&/g,"\x26amp;"),d=-1===d.indexOf("?")?d+"?":d+"\x26amp;",d+="hl\x3d"+(this.getParentEditor().config.language?this.getParentEditor().config.language:"en")+"\x26amp;version\x3d3",a=a+('\x3cobject width\x3d"'+g+'" height\x3d"'+h+'" '+c+"\x3e")+('\x3cparam name\x3d"movie" value\x3d"'+d+'"\x3e\x3c/param\x3e'),a+='\x3cparam name\x3d"allowFullScreen" value\x3d"true"\x3e\x3c/param\x3e',
a+='\x3cparam name\x3d"allowscriptaccess" value\x3d"always"\x3e\x3c/param\x3e',a+='\x3cembed src\x3d"'+d+'" type\x3d"application/x-shockwave-flash" ',a+='width\x3d"'+g+'" height\x3d"'+h+'" '+c+' allowscriptaccess\x3d"always" ',a+='allowfullscreen\x3d"true"\x3e\x3c/embed\x3e',a+="\x3c/object\x3e"):!0===this.getContentElement("youtubePlugin","chkNoEmbed").getValue()?a+='\x3ca href\x3d"'+d+'" \x3e\x3cimg width\x3d"'+g+'" height\x3d"'+h+'" src\x3d"'+("//img.youtube.com/vi/"+e+"/sddefault.jpg")+'" '+c+
"/\x3e\x3c/a\x3e":(a+='\x3ciframe allow\x3d"'+k+';" width\x3d"'+g+'" height\x3d"'+h+'" src\x3d"'+d+'" '+c,a+='frameborder\x3d"0" allowfullscreen\x3e\x3c/iframe\x3e');!0===this.getContentElement("youtubePlugin","chkResponsive").getValue()&&(a+="\x3c/div\x3e")}a=CKEDITOR.dom.element.createFromHtml(a);this.getParentEditor().insertElement(a)}}})}})})();
